...
## IPython notebooks for TEC maps preprocessing
...
## IPython notebooks for processing the comparison of local values ​​of TEC maps with the local TEC time series generated by the Gopi Seemala application
